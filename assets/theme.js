...
timber.mobileNavToggle = function () {
  ...
  $toggleBtns.on('click', function() {
    ...
    var $curEl = $el.closest('.mobile-nav__has-sublist');
//     $('.mobile-nav__has-sublist').not($curEl).each(function () {
// 		$(this).removeClass('mobile-nav--expanded');
//       	toggleState = true;
//  	});
    $curEl.toggleClass('mobile-nav--expanded', toggleState);
  });
};
...
timber.Drawers = (function () {
  ...
  Drawer.prototype.open = function (evt) {
	...
	//$("#IconHamburger").css('color', 'transparent !important');
	//$("#NavDrawer").dimBackground();
	$("#IconHamburger").removeClass("icon-hamburger");
	$("#IconHamburger").addClass("icon-x");
  ...
  Drawer.prototype.close = function () {
	...
	// $("#IconHamburger").css('color', 'white !important');
// 	$("#NavDrawer").undim();
	$("#IconHamburger").removeClass("icon-x");
   	$("#IconHamburger").addClass("icon-hamburger");
...
var slickTheme = (function(module, $) {
  ...
  init = function (options) {
    ...
    settings.$element.slick({
      ...
      easing 		 : 'linear',
      dots           : settings.dots,
      adaptiveHeight : false, //settings.fullscreen ? false : settings.adaptiveHeight,
      draggable      : false,
      fade           : false,
      autoplay       : true,
      autoplaySpeed  : 7000,
  ...
  if(!theme.cache.$html.hasClass('lt-ie9')) {
    enquire.register(theme.variables.mediaQuerySmall, {
      match: function () {
        ...
        //$('div.product-single__photos').removeClass('fotorama');
        //theme.createImageCarousel();
        //$('.fotorama').fotorama({nav: 'dots'});
      ...
      unmatch: function () {
        console.log( "go big!" );
        //$('div.product-single__photos').addClass('fotorama');
        //theme.destroyImageCarousel();
        //$('.fotorama').fotorama({nav: 'thumbs'});
